...
class C {
  static const Color orange = Color(0xFFF6AE2D);  // Orange color
    static const Color yellow = Color(0xFFF26419);  // Orange color
  static const Color blue = Color(0xFF33658A);    // Blue color
